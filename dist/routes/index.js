...
const posLimits_routes_1 = __importDefault(require("./posLimits.routes"));
const profitLogs_routes_1 = __importDefault(require("./profitLogs.routes"));
const store_routes_1 = __importDefault(require("./store.routes"));
const reportedTransactions_routes_1 = __importDefault(require("./reportedTransactions.routes"));
...
router.use("/pos-limits", posLimits_routes_1.default);
router.use("/profit-logs", profitLogs_routes_1.default);
router.use("/store", store_routes_1.default);
router.use("/reported-transactions", reportedTransactions_routes_1.default);
